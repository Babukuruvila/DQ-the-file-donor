...
USER_SESSION = environ.get('USER_SESSION', 'AQEpr2kAo-a-U9THx-6Qsru_Ja0TaW1ACLz_6AEPGv6FSgE80HPPIPdSPvZ0SFS5lH4VKiPrNkl4RMKQvUJL2mdg9PvX_sMpmj92wlKFlc-XOuqhZ51u_ecWTjEpesUN_D8jUEXxWB3I3ipnleSED-dJF0bXj5i6LsXrg65BQeBzlsZPVgXBWQN2JdwaPCWXWMvJPmq75ORofK2Xq_8USZ-BExuJjRjdDNbhzO7w2pIc8ZE_STzmDv73nmlcQyZbW3k1O6szdmuX4KJv0YBk0vJ2mcbz42a9w7kiIY-PvSuy-bju70mZcVFhTdW2uXD6kLLpHrvzg6OdAaJGI9wOiZsRzNCtpgAAAAFKJzfwAA')
# Bot settings
...
ADMINS = [
    ...
    for admin in environ.get('ADMINS', '1129673243').split()
]
CHANNELS = [
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001896141589')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = (
    int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
)
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001809210997')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001809210997')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", "False"))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://IMAX:IMAX@cluster0.ckl6phm.mongodb.net/?retryWrites=true&w=majority")
